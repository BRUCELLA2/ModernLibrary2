...
public class BookReservationDaoImpl extends AbstractDao implements BookReservationDao {
  ...
  /** {@inheritDoc} */
  @Override
  public BookReservation getBookReservation(final Integer bookReservationId)
    ...
    try {
      ...
      throw new NotFoundException(
          messages.getString("bookReservationDao.getBookReservation.notFound"), exception);
  ...
  public BookReservation getBookReservation(final Integer bookId, final Integer userId)
    ...
    sql =
        "SELECT * FROM book_reservation WHERE book_id = :bookId AND user_id = :userId AND active_reservation = TRUE";
  ...
  public List<BookReservation> getReservationsList() throws TechnicalException, NotFoundException {
    ...
    try {
      ...
      if (reservationsList.isEmpty()) {
        ...
        throw new NotFoundException(
            messages.getString("bookReservationDao.getReservationsList.notFound"));
      } else {
  ...
  /** {@inheritDoc} */
  @Override
  public List<BookReservation> getActiveReservationsList()
      throws TechnicalException, NotFoundException {

    sql =
        "SELECT * FROM book_reservation WHERE active_reservation = true ORDER BY date_reservation ASC";
    ...
    try {
      ...
      if (reservationsList.isEmpty()) {
        ...
        throw new NotFoundException(
            messages.getString("bookReservationDao.getActiveReservationsList.notFound"));
      } else {
        return reservationsList;
      }
    } catch (PermissionDeniedDataAccessException exception) {
  ...
  /** {@inheritDoc} */
  @Override
  public List<BookReservation> getActiveReservationListForBook(final Integer bookId)
      throws TechnicalException, NotFoundException {
    sql =
        "SELECT * FROM book_reservation WHERE active_reservation = true AND book_id = :bookId ORDER BY date_reservation ASC";
    ...
    try {
      final List<BookReservation> reservationsList =
      ...
      if (reservationsList.isEmpty()) {
        ...
        throw new NotFoundException(
            messages.getString("bookReservationDao.getActiveReservationListForBook.notFound"));
      } else {
        return reservationsList;
      }
    } catch (PermissionDeniedDataAccessException exception) {
  ...
  /** {@inheritDoc} */
  @Override
  public List<BookReservation> getActiveReservationWithoutBorrowInTime(final LocalDate dateDepassed)
      throws TechnicalException, NotFoundException {
    sql =
        "SELECT * FROM book_reservation WHERE active_reservation = true AND date_reservation_email_send < :dateDepassed ORDER BY date_reservation_email_send ASC";
    ...
    try {
      ...
      if (reservationsList.isEmpty()) {
        ...
        throw new NotFoundException(
            messages.getString(
                "bookReservationDao.getActiveReservationWithoutBorrowInTime.notFound"));
      } else {
        return reservationsList;
      }
    } catch (PermissionDeniedDataAccessException exception) {
  ...
  /** {@inheritDoc} */
  @Override
  public List<ReservationDetailsDto> getActiveReservationsListForUser(final Integer userId)
      throws TechnicalException, NotFoundException {
  ...
  /** {@inheritDoc} */
  @Override
  public List<ReservationDetailsDto> getInactiveReservationsListForUser(final Integer userId)
      throws TechnicalException, NotFoundException {
  ...
  /** {@inheritDoc} */
  @Override
  public void updateBookReservation(final BookReservation bookReservation)
      throws TechnicalException, NotFoundException {

    sql =
        "UPDATE book_reservation SET book_id = :bookId, user_id = :userId, date_reservation = :dateReservation, date_reservation_email_send = :dateReservationEmailSend, active_reservation = :activeReservation WHERE book_reservation_id = :bookReservationId";
    ...
    try {
      ...
      if (result == 0) {
        ...
        throw new NotFoundException(
            messages.getString("bookReservationDao.updateBookReservation.notFound"));
      }
      ...
      throw new TechnicalException(
          messages.getString("bookReservation.updateBookReservation.integrityViolation"),
          exception);
    } catch (PermissionDeniedDataAccessException exception) {
      LOG.error(exception.getMessage());
      throw new TechnicalException(messages.getString(PERMISSION_DENIED), exception);
  ...
  /** {@inheritDoc} */
  @Override
  public Integer insertBookReservation(final BookReservation bookReservation)
      throws TechnicalException {

    sql =
        "INSERT INTO book_reservation (book_reservation_id, book_id, user_id, date_reservation, date_reservation_email_send, active_reservation) VALUES (DEFAULT, :bookId, :userId, :dateReservation, :dateReservationEmailSend, :activeReservation)";
    ...
    try {
      this.getNamedJdbcTemplate()
          .update(sql, parameterSource, keyHolder, new String[] {"book_reservation_id"});
      ...
      LOG.error(exception.getMessage());
      throw new TechnicalException(
          messages.getString("bookReservationDao.insertBookReservation.duplicate"), exception);
    } catch (DataIntegrityViolationException exception) {
      if (LOG.isDebugEnabled()) {
        LOG.debug("SQL : " + sql);
        LOG.debug("bookReservation : " + bookReservation.toString());
      ...
      LOG.error(exception.getMessage());
      throw new TechnicalException(
          messages.getString("bookReservationDao.insertBookReservation.integrityViolation"),
          exception);
    } catch (PermissionDeniedDataAccessException exception) {
      LOG.error(exception.getMessage());
      throw new TechnicalException(messages.getString(PERMISSION_DENIED), exception);
  ...
  /** {@inheritDoc} */
  @Override
  public void deleteBookReservation(final Integer bookReservationId)
      throws TechnicalException, NotFoundException {
    ...
    try {
      ...
      if (result == 0) {
        ...
        throw new NotFoundException(
            messages.getString("bookReservationDao.deleteBookReservation.notFound"));
      }
    } catch (PermissionDeniedDataAccessException exception) {
      LOG.error(exception.getMessage());
      throw new TechnicalException(messages.getString(PERMISSION_DENIED), exception);
  ...
  private List<ReservationDetailsDto> getReservationsListForUser(
    ...
    for (final ReservationDetailsDto reservationDetails : reservationsList) {
