 ...
 * BookDetailsDto is set to null. The end borrow date is set to null. The number of active
 * reservations is set to null. An update of the BookDetailsDto is necessary after row mapping to
