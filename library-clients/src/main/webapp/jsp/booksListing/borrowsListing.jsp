...
<div class="container" style="margin-top: 30px">
    <div class="card mb-4">
        <div class="card-header text-white bg-secondary"><h4 class="text-center">Emprunts en cours</h4></div>
        <div class="card-body">
                    ...
                    <s:iterator value="borrowsList" var="books">
                        <tr>
                            ...
                            <td class="text-center">
                                <s:set var="endDateBeforeNow" value="%{isBeforeToNow(#books)}"/>
                                <s:if test="#endDateBeforeNow">
                                    Délai dépassé !
                                </s:if>
                                <s:elseif test="extension">
                                    Déjà prolongé
                                </s:elseif>
                                <s:else>
