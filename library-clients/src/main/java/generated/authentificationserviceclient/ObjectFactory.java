...
public class ObjectFactory {
  ...
  private static final QName _AddUserResponse_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "addUserResponse");
  private static final QName _Login_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "login");
  private static final QName _AddRoleToUser_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "addRoleToUser");
  private static final QName _LoginAvailable_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "loginAvailable");
  private static final QName _LoginAvailableResponse_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "loginAvailableResponse");
  private static final QName _AddUser_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "addUser");
  private static final QName _AddRoleToUserResponse_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "addRoleToUserResponse");
  private static final QName _ModifyUserResponse_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "modifyUserResponse");
  private static final QName _ModifyUser_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "modifyUser");
  ...
  private static final QName _LoginResponse_QNAME =
      new QName("http://services.libraryws.projects.brucella.fr/", "loginResponse");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: generated.authentificationserviceclient
   */
  ...
  public JAXBElement<AddUserResponse> createAddUserResponse(AddUserResponse value) {
    return new JAXBElement<AddUserResponse>(
        _AddUserResponse_QNAME, AddUserResponse.class, null, value);
  }
  ...
  public JAXBElement<LoginAvailable> createLoginAvailable(LoginAvailable value) {
    return new JAXBElement<LoginAvailable>(
        _LoginAvailable_QNAME, LoginAvailable.class, null, value);
  }
  ...
  @XmlElementDecl(
      namespace = "http://services.libraryws.projects.brucella.fr/",
      name = "loginAvailableResponse")
  public JAXBElement<LoginAvailableResponse> createLoginAvailableResponse(
      LoginAvailableResponse value) {
    return new JAXBElement<LoginAvailableResponse>(
        _LoginAvailableResponse_QNAME, LoginAvailableResponse.class, null, value);
  }
  ...
  @XmlElementDecl(
      namespace = "http://services.libraryws.projects.brucella.fr/",
      name = "addRoleToUserResponse")
  public JAXBElement<AddRoleToUserResponse> createAddRoleToUserResponse(
      AddRoleToUserResponse value) {
    return new JAXBElement<AddRoleToUserResponse>(
        _AddRoleToUserResponse_QNAME, AddRoleToUserResponse.class, null, value);
  }
  ...
  public JAXBElement<ModifyUserResponse> createModifyUserResponse(ModifyUserResponse value) {
    return new JAXBElement<ModifyUserResponse>(
        _ModifyUserResponse_QNAME, ModifyUserResponse.class, null, value);
  }
