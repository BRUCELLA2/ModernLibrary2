 ...
 */
@WebServiceClient(name = "BookService", targetNamespace = "http://services.libraryws.projects.brucella.fr/",
    wsdlLocation = "http://modernlibrary-web-service:8080/library-ws-services/services/bookService?wsdl")
public class BookService_Service extends Service {
  ...
  private final static QName BOOKSERVICE_QNAME = new QName("http://services.libraryws.projects.brucella.fr/",
      "BookService");
  ...
  public BookService getBookServicePort() {
    return super
        .getPort(new QName("http://services.libraryws.projects.brucella.fr/", "BookServicePort"), BookService.class);
  }
