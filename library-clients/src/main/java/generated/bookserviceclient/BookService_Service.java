 ...
 *
 */
@WebServiceClient(name = "BookService", targetNamespace = "http://services.libraryws.projects.brucella.fr/", wsdlLocation = "http://modernlibrary-web-service:8080/library-ws-services/services/bookService?wsdl")
    ...
    extends Service
{
  ...
  private final static QName BOOKSERVICE_QNAME = new QName("http://services.libraryws.projects.brucella.fr/", "BookService");

  static {
    URL url = null;
    WebServiceException e = null;
    try {
      url = new URL("http://modernlibrary-web-service:8080/library-ws-services/services/bookService?wsdl");
  ...
  public BookService getBookServicePort() {
    return super.getPort(new QName("http://services.libraryws.projects.brucella.fr/", "BookServicePort"), BookService.class);
  }
  ...
  public BookService getBookServicePort(WebServiceFeature... features) {
    return super.getPort(new QName("http://services.libraryws.projects.brucella.fr/", "BookServicePort"), BookService.class, features);
  }
