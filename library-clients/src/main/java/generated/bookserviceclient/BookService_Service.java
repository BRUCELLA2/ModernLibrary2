 ...
 * 
 */
@WebServiceClient(name = "BookService", targetNamespace = "http://services.libraryws.projects.brucella.fr/", wsdlLocation = "http://0.0.0.0:8080/library-ws-services/services/bookService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://0.0.0.0:8080/library-ws-services/services/bookService?wsdl");
