...
/**
 * Classe Java pour booksSearchClientCriteriaDto complex type.
 *
...
@XmlType(
    name = "booksSearchClientCriteriaDto",
    propOrder = {"authorLastName", "bookAvailable", "ean13", "genreName", "publisherName", "title"})
