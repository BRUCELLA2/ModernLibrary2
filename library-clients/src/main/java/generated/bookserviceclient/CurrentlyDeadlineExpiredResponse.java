...
/**
 * Classe Java pour currentlyDeadlineExpiredResponse complex type.
 *
 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://services.libraryws.projects.brucella.fr/}currentlyBorrowExpiredDto" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CurrentlyDeadlineExpiredResponse {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CurrentlyBorrowExpiredDto }
   */
